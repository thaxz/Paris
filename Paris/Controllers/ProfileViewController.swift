...
class ProfileViewController: UIViewController {
    ...
    let posterImage: UIImageView = UIImageView(image: UIImage(named: "restaurante"))
...
//        posterImage.backgroundColor = .systemPurple
...
//
//        NSLayoutConstraint.activate([
//            placeInfoView.leadingAnchor.constraint(equalTo: <#T##NSLayoutAnchor<NSLayoutYAxisAnchor>#>)
//        ])
